...
export const planuri = [
  {
    ...
    pret: 'Gratuit',
    detaliu: '20 de minute, pe Zoom',
    beneficii: ['Evaluare sinceră a nivelului', 'Discutăm obiectivul și termenul tău', 'Pleci cu un plan, chiar dacă nu continui'],
...
export const intrebari = [
  ...
  },
  {
    ...
    raspuns: 'Prin transfer bancar sau Revolut, după fiecare lecție sau lunar, cum îți e mai comod. Fără abonament și fără plăți în avans pentru luni întregi.',
  },
  {
